---
title: 源码系列(2)——View被添加到屏幕窗口上的源码流程
date: 2020-06-11 18:13:43
tags: [Android, PhoneWindow, UI绘制, , 源码]
summary: 源码系列(2)——View被添加到屏幕窗口上的源码流程
---

<!-- toc -->

# 一、前言
>本文主要讲述**View被添加到屏幕窗口上的源码流程**
源码基于 **Android API 28**，即**Oreo 8.0.0_r4**
在线查看源码建议使用：[http://androidxref.com/](http://androidxref.com/)
源码系列文章：
{% post_link 源码系列(1) 源码系列(1)——ActivityThread的理解和APP的启动过程 %}
...
5. 层级图如下：
    ![层级图](源码系列(2)/UI添加view到window.png)
